...
public partial class ApplicationDbContext : DbContext
{
    ...
    public virtual DbSet<KetQuaCheckMatKhau> KetQuaCheckMatKhaus { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<NguoiDung>(entity =>
        {
            ...
            entity.Property(e => e.DangNhaploi).HasDefaultValue(0);
            ...
            entity.Property(e => e.MatKhauMaHoa).HasMaxLength(200);
        ...
        modelBuilder.Entity<KetQuaCheckMatKhau>()
            .HasNoKey()
            .ToView(null);
